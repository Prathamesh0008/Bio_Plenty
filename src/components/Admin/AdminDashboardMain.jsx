...
// // Filter adminOrders for orders placed today and calculate total earnings
// const todayEarnings = adminOrders
//   .filter(order => order.createdAt.slice(0, 10) === today)
//   .reduce((acc, order) => acc + order.totalPrice, 0)

// const ToBalance = todayEarnings.toFixed(2) || 0; 
      ...
      {adminOrderLoading ? (
        ...
        <div className="w-full p-4">
          ...
          <div className="w-full block 800px:flex items-center justify-between">
            ...
            <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white shadow rounded px-2 py-5">
              <div className="flex items-center">
                <FaBagShopping size={30} className="mr-2" fill="#00000085" />
                <h3
                  className={`${styles.productTitle} !text-[18px] leading-5 !font-[400] text-[#00000085]`}
                >
                  All Orders
